    ...
    return (
        <div className='form-login'>
            <div className="form-container">
                <Link to="/" className='text-decoration-none'><p className="title">Đăng kí tài khoản</p></Link>
                <form className="form">
                    ...
                    <button className="sign">Đăng kí</button>
                </form>
                ...
                <p className="signup">
                    ...
                    <Link rel="noopener noreferrer" to="/signin" className="">
                        Sign in
                    </Link>
                </p>
                <Outlet />
