...
export const schemaSignup = yup.object().shape({
    ...
    password: yup.string().min(6, 'Tối thiểu 6 kí tự').typeError("Tối thiểu 6 kí tự").required("Trường dữ liệu bắt buộc"),
...
export const schemaSignin = yup.object().shape({
    ...
    password: yup.string().min(6).typeError("Tối thiểu 6 kí tự").required("Trường dữ liệu bắt buộc"),
})
export const schmeAddProduct = yup.object().shape({
    ...
    sizes: yup.string().required("Kích cỡ là bắt buộc"),
    ...
    salient_features: yup.string().min(50, "Tối thiểu 50 kí tự").max(225, "Tối đa 220 kí tự").required('Trường dữ liệu bắt buộc'),
})
